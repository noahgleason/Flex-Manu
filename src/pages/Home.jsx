    ...
    <>
      ...
      <section className="wrap" style={{ paddingTop: "clamp(24px,3vw,40px)", paddingBottom: "clamp(40px,5vw,64px)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: "clamp(20px,2.5vw,32px)" }}>
          {[
            { title: "Gears & Splines", body: "Internal & external, 1″–240″ diameter. Spur, helical, bevel, worm, rack, herringbone; involute & straight-sided splines." },
            { title: "Grinding & Honing", body: "All surfaces, ¼″–48″ dia × 13′ long. OD, ID, surface & jig; centerless to 20′, Blanchard, gear-tooth & spline grinding." },
            { title: "Turning", body: "To 156″ dia × 96″ swing (VTL) and 42″ × 160″ long. CNC, screw machine, gun drilling; rolls, spindles, axles, shafts." },
            { title: "Milling, Boring & Drilling", body: "To 6′ square cube. Five-axis CNC, boring mill, clutch teeth, camslots & helix slots on weldments, castings & forgings." },
          ].map(({ title, body }) => (
      ...
      <section className="wrap" style={{ paddingBottom: "clamp(40px,5vw,72px)", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: "clamp(28px,4vw,64px)", alignItems: "center" }}>
        <figure className="blueprint duotone" style={{ margin: 0, aspectRatio: "4/3" }}>
          <i className="corner tl"></i><i className="corner tr"></i><i className="corner bl"></i><i className="corner br"></i>
          <div className="fx-imgph">Machined gear / part photo<br />(replace with assets/part.jpg)</div>
        </figure>
        <div>
